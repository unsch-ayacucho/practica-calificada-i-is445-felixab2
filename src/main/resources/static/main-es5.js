...
var ProveedorModel = /** @class */ (function () {
    function ProveedorModel() {
    }
...
var BienvenidoComponent = /** @class */ (function () {
    function BienvenidoComponent(_tiendaSrv) {
    ...
    BienvenidoComponent.prototype.imprimirProveedores = function () {
        var _this = this;
        this._tiendaSrv.getAllProveedor().subscribe(function (res) {
            _this.proveedores = res;
            // console.log(res);
        });
    };
    BienvenidoComponent.prototype.imprimirProducto = function () {
        var _this = this;
        this._tiendaSrv.getAllProductor().subscribe(function (res) {
            _this.productos = res;
        });
    };
    BienvenidoComponent.prototype.GuardarOeditar = function (basicModal2) {
        var _this = this;
        this._tiendaSrv.saveOrUpdateProducto(this.newproducto).subscribe(function (res) {
            swal('Bien!', 'Guardado!', 'success').then(function () {
                _this.imprimirProducto();
            });
            console.log(res);
        });
        basicModal2.hide();
    ...
    BienvenidoComponent.prototype.setNewProveedores = function (proveedor) {
        this.newproducto.idproveedor = parseInt(proveedor);
    };
    BienvenidoComponent.prototype.EditarProducto = function (producto, basicModal2) {
        basicModal2.show();
...
var ProveedorComponent = /** @class */ (function () {
    function ProveedorComponent(_tiendaSrv) {
        this._tiendaSrv = _tiendaSrv;
        this.term = '';
    ...
    ProveedorComponent.prototype.imprimirProveedores = function () {
        var _this = this;
        this._tiendaSrv.getAllProveedor().subscribe(function (res) {
            _this.proveedores = res;
        });
    };
    ProveedorComponent.prototype.GuardarOeditarProveedor = function (basicModal2) {
        var _this = this;
        this._tiendaSrv.saveOrUpdateProveedor(this.Newproveedor).subscribe(function (res) {
            swal('Bien!', 'Guardado!', 'success').then(function () {
                _this.imprimirProveedores();
            });
        });
        basicModal2.hide();
        this.Newproveedor = new src_app_model_tienda_model__WEBPACK_IMPORTED_MODULE_3__["ProveedorModel"]();
    };
    ProveedorComponent.prototype.editarProveedor = function (proveedor, basicModal2) {
        basicModal2.show();
...
var TiendaService = /** @class */ (function () {
    function TiendaService(http) {
        this.http = http;
    }
    // =================== proveedor ===================== 
    // listar 
    TiendaService.prototype.getAllProveedor = function () {
    ...
    // Guardar y editar
    TiendaService.prototype.saveOrUpdateProveedor = function (proveedor) {
    ...
    // ============= producto ==================== 
    // listar 
    TiendaService.prototype.getAllProductor = function () {
        return this.http.get('http://localhost:8080/listaProductos');
    };
    // guardar y editar
    TiendaService.prototype.saveOrUpdateProducto = function (producto) {
